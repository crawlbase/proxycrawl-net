...
namespace ProxyCrawl
{
    public class StorageAPI
    {
        ...
        public class Response
        {
            ...
            public int? ProxyCrawlStatus { get; internal set; }
        ...
        private const string BASE_URL = "https://api.proxycrawl.com/storage";
        ...
        public Response GetByUrl(string url, string format = "html")
        {
            ...
            return new Response()
            {
                ...
                ProxyCrawlStatus = proxyCrawlStatus,
                URL = returnedUrl,
                RID = returnedRid,
                StoredAt = storedAt,
                Body = Body
